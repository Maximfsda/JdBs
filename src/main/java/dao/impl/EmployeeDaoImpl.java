...
public class EmployeeDaoImpl implements EmployeeDao {
    ...
    private static final String INSERT = "INSERT INTO employee(firstName,lastName,gender,age,city_id) VALUES(?,?,?,?,?)";
    ...
    private static final String UPDATE_BY_ID = "UPDATE employee SET firstName = ?,lastName = ?,gender = ?,age = ?, city_id = ? WHERE id =?";
    private static final String DELETE_BY_ID = "DELETE FROM employee WHERE id =?";

    private final CityDao cityDao = new CityDaoImp();
